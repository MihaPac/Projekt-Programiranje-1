...
#Izbral bom 20000 izdelkov iz vsake kategorije, nima vsaka kategorija 20000 izdelkov, ebay ne vraèa error message za
#preveliko številko strani, zato bom z regexom moral opraviti z napakami.
...
for kategorija in kategorije:
    for stran in range(1, 2):
        ...
        #Boljše, da ne uporabljam tega, èe ne bo nemogoèe s temi datotekami se ukvarjati, razen dneva, dan bo pa že.
